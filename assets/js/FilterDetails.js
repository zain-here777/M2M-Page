...
$(document).ready(function() {
  ...
  var rangeSlider = document.getElementById('slider-ranges');
  ...
  rangeSlider.noUiSlider.on('update', function(values, handle) {
      document.getElementById('sliders-range-value1').innerHTML = values[0];
      document.getElementById('sliders-range-value2').innerHTML = values[1];
